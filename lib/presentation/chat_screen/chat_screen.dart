...
import 'package:chatter/widgets/app_bar/appbar_title.dart';
import 'package:chatter/widgets/app_bar/appbar_title_circleimage.dart';
import 'package:chatter/widgets/app_bar/appbar_title_image.dart';
      ...
      return SafeArea(
          child: Scaffold(
              ...
              body: Container(
                  ...
                  padding:
                      EdgeInsets.symmetric(horizontal: 16.h, vertical: 41.v),
                  child: Column(
              ...
              bottomNavigationBar: _buildMessageBoxRow(context)));
    });
  }
